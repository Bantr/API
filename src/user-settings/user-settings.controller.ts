...
export class SettingsController {
    ...
    async setBanType(@Body() setBanType: SetBanTypeDto, @GetUser() user: User): Promise<QueryDeepPartialEntity<UserSettings>> {
    ...
    async setNotificationType(@Body() setNotificationType: SetNotificationTypeDto, @GetUser() user: User) {
